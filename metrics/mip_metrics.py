...
class MIPMetrics(StackableMetrics):
    ...
    def update(self, prediction: torch.Tensor, batch_holder: MIPBatchHolder, **kwargs):
        ...
        fully_sat_eq_mips = self._fully_satisfied_eq(prediction, vars_eq_const_graph, eq_const_values, eq_const_inst_graph)
    ...
    def _fully_satisfied_eq(self, prediction, vars_eq_const_graph, eq_const_values, eq_const_inst_graph):
        sat_instances = self._mask_satisfied_eq_instances(eq_const_inst_graph, eq_const_values, prediction,
                                                          vars_eq_const_graph)
        return torch.mean(sat_instances.float())
